    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
              ...
              <span className="text-primary-600"> Expert Market Research</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" size="lg" className="text-secondary-foreground text-lg px-8 py-3" onClick={handleDownloadSampleReport}>
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-foreground mb-6">Why Choose Our Market Research</h2>
              <p className="text-xl text-muted-foreground">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-foreground mb-6">Popular Export Markets</h2>
              <p className="text-xl text-muted-foreground">
                ...
                <Card key={index} className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <CardTitle className="flex items-center justify-between">
                      ...
                      <span className={`text-xs px-2 py-1 rounded-full ${
                        market.difficulty === 'Low' ? 'bg-primary-100 text-primary-700' :
                        market.difficulty === 'Medium' ? 'bg-accent-100 text-accent-700' :
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-primary-600">{market.growthRate}</span>
                    </div>
                    <div>
      ...
      <section className="py-20 bg-primary-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-foreground mb-6">Our Research Process</h2>
              <p className="text-xl text-muted-foreground">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-foreground mb-6">Sample Report Structure</h2>
              <p className="text-xl text-muted-foreground">
            ...
            <Card className="border-2 border-primary-200">
              ...
              <CardContent className="p-8">
                ...
                <div className="text-center mt-8">
                  <Button variant="outline" className="border-primary-600 text-primary-600 hover:bg-primary-50" onClick={handleDownloadSampleReport}>
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-foreground mb-6">Client Success Stories</h2>
              <p className="text-xl text-muted-foreground">
                  ...
                  <CardContent>
                    <div className="flex justify-between items-end">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-lg font-bold text-primary-700">{testimonial.result}</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-foreground mb-6">Research Packages</h2>
              <p className="text-xl text-muted-foreground">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {pricing.map((pkg, index) => (
                <Card key={index} className={index === 1 ? 'border-primary-500 border-2 relative' : ''}>
                  {index === 1 && (
                  ...
                  <CardContent>
                    ...
                    <Button 
                      asChild 
                      className={`w-full ${index === 1 ? 'bg-primary-600 hover:bg-primary-700' : ''}`}
      ...
      <section className="py-20 bg-primary-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" size="lg" className="bg-white text-primary-600 hover:bg-primary-50" onClick={handleDownloadSampleReport}>
              <Eye className="mr-2 w-5 h-5" />
              View Sample Report
            </Button>
          </div>
