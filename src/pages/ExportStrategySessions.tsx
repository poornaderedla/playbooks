        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-orange-600"> Mentorship Sessions</span>
            </h1>
                    ...
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <div className="flex items-center space-x-4 mt-2">
                          ...
                          <span className="text-orange-600 font-bold text-lg">{session.price}</span>
                        </div>
                      </div>
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {sessionFormats.map((format, index) => (
                <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-orange-100 rounded-full mx-auto mb-4">
                      <format.icon className="w-8 h-8 text-orange-600" />
                    </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {packages.map((pkg, index) => (
                <Card key={index} className={`relative ${pkg.popular ? 'ring-2 ring-orange-500 transform scale-105' : ''}`}>
                  {pkg.popular && (
                  ...
                  <CardContent>
                    ...
                    <Button 
                      asChild 
                      className={`w-full mt-8 ${pkg.popular ? 'bg-orange-600 hover:bg-orange-700' : ''}`}
